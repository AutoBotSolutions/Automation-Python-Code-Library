...
# Creating widgets
follow_stat_label = tkinter.Label(frame, width=19, text="Complete Follow:", bg='#333333', fg="#FFFFFF", font=("Cantrell", 12))
likes_stat_label = tkinter.Label(frame, width=19, text="Complete Likes:", bg='#333333', fg="#FFFFFF", font=("Cantrell", 12))
unfollow_stat_label = tkinter.Label(frame, width=19, text="Complete Unfollow:", bg='#333333', fg="#FFFFFF", font=("Cantrell", 12))
comment_stat_label = tkinter.Label(frame, width=19, text="Complete Comments:", bg='#333333', fg="#FFFFFF", font=("Cantrell", 12))
...
# Placing widgets on the screen
checkbox1.grid(row=3, column=0, padx=13, pady=5, sticky="w")
checkbox2.grid(row=3, column=1, padx=13, pady=5, sticky="w")
checkbox3.grid(row=3, column=2, padx=13, pady=5, sticky="w")
checkbox4.grid(row=3, column=3, padx=13, pady=5, sticky="w")
# Placing widgets on the screen
start_button.grid(row=4, column=0, columnspan=4, padx=13, pady=1, sticky="w")
stop_button.grid(row=4, column=1, columnspan=4, padx=13, pady=1, sticky="w")
pause_button.grid(row=4, column=2, columnspan=4, padx=13, pady=1, sticky="w")
close_button.grid(row=4, column=3, columnspan=4, padx=13, pady=1, sticky="w")
# Placing widgets on the screen
follow_stat_label.grid(row=5, column=0, columnspan=1, padx=1, pady=1)
likes_stat_label.grid(row=5, column=1, columnspan=1, padx=1, pady=1)
unfollow_stat_label.grid(row=5, column=2, columnspan=1, padx=1, pady=1)
comment_stat_label.grid(row=5, column=3, columnspan=1, padx=1, pady=1)
